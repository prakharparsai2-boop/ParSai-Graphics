        ...
        <div className="container">
          ...
          <div className="about-grid">
            ...
            <div className="about-content-col">
              <div className="bio-section anim-fade-up delay-300">
                <h3 className="section-heading">The Backstory</h3>
                ...
                <p className="bio-text">
                  ...
                  keep audiences engaged. I’ve delivered successful projects for
              ...
              <div className="philosophy-grid">
                <div className="philosophy-card anim-fade-up">
                  <Heart className="philo-icon text-red" />
                  <h4>Emotion First</h4>
                  <p>
                ...
                <div className="philosophy-card anim-fade-up">
                  <Edit3 className="philo-icon text-blue" />
                  <h4>Story Driven</h4>
                  <p>
                ...
                <div className="philosophy-card anim-fade-up">
                  <Camera className="philo-icon text-yellow" />
                  <h4>Visual Rhythm</h4>
                  <p>
                ...
                <div className="philosophy-card anim-fade-up">
                  <Award className="philo-icon text-purple" />
                  <h4>Retention King</h4>
                  <p>
